	...
	<div class="col-xs-12">
		...
		<div class="alert alert-block alert-success">
			...
			<strong class="green">
   			...
   			的前端基于Bootstrap、jQuery、HTML5和CSS3，后端集成Hibernate、Spring、Spring MVC和CAS等开源框架。
		</div>
				...
				<div class="portlet solid light-grey bordered">
					...
					<div class="portlet-body">
						<div id="site_activities_loading">
							<img src="${contextPath}/static/dist/img/loading.gif" alt="loading"/>
						</div>
								...
								<div id="member-tab" class="tab-pane">
									...
									<div class="clearfix">
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Bob Doe's avatar" src="${contextPath}/static/dist/avatars/user.jpg" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Joe Doe's avatar" src="${contextPath}/static/dist/avatars/avatar2.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Jim Doe's avatar" src="${contextPath}/static/dist/avatars/avatar.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Alex Doe's avatar" src="${contextPath}/static/dist/avatars/avatar5.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Bob Doe's avatar" src="${contextPath}/static/dist/avatars/avatar2.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Susan's avatar" src="${contextPath}/static/dist/avatars/avatar3.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Phil Doe's avatar" src="${contextPath}/static/dist/avatars/avatar4.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Alexa Doe's avatar" src="${contextPath}/static/dist/avatars/avatar1.png" />
											</div>
								...
								<div id="comment-tab" class="tab-pane">
									...
									<div class="comments">
										<div class="itemdiv commentdiv">
											<div class="user">
												<img alt="Bob Doe's Avatar" src="${contextPath}/static/dist/avatars/avatar.png" />
											</div>
										...
										<div class="itemdiv commentdiv">
											<div class="user">
												<img alt="Jennifer's Avatar" src="${contextPath}/static/dist/avatars/avatar1.png" />
											</div>
										...
										<div class="itemdiv commentdiv">
											<div class="user">
												<img alt="Joe's Avatar" src="${contextPath}/static/dist/avatars/avatar2.png" />
											</div>
										...
										<div class="itemdiv commentdiv">
											<div class="user">
												<img alt="Rita's Avatar" src="${contextPath}/static/dist/avatars/avatar3.png" />
											</div>
						...
						<div class="widget-main no-padding">
							...
							<div class="dialogs">
								<div class="itemdiv dialogdiv">
									<div class="user">
										<img alt="Alexa's Avatar" src="${contextPath}/static/dist/avatars/avatar1.png" />
									</div>
								...
								<div class="itemdiv dialogdiv">
									<div class="user">
										<img alt="John's Avatar" src="${contextPath}/static/dist/avatars/avatar.png" />
									</div>
								...
								<div class="itemdiv dialogdiv">
									<div class="user">
										<img alt="Bob's Avatar" src="${contextPath}/static/dist/avatars/user.jpg" />
									</div>
								...
								<div class="itemdiv dialogdiv">
									<div class="user">
										<img alt="Jim's Avatar" src="${contextPath}/static/dist/avatars/avatar4.png" />
									</div>
...
<!--[if lte IE 8]>
  <script src="${contextPath}/static/dist/js/excanvas.min.js"></script>
<![endif]-->
<script type="text/javascript">
		var scripts = [ null, "${contextPath}/static/dist/js/jquery-ui.custom.min.js", "${contextPath}/static/dist/js/jquery.ui.touch-punch.min.js", "${contextPath}/static/dist/js/jquery.easypiechart.min.js", "${contextPath}/static/dist/js/jquery.sparkline.min.js",
        		"${contextPath}/static/dist/js/flot/jquery.flot.min.js", "${contextPath}/static/dist/js/flot/jquery.flot.pie.min.js", "${contextPath}/static/dist/js/flot/jquery.flot.resize.min.js", "${contextPath}/static/dist/js/activities-serverload.min.js", null ]
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		Index.initCharts(); // init activities-serverload.min.js's method
